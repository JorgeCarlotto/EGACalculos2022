...
const sazm = { latitude: -37.9297222, longitude: -57.5763888 };
const sazb = { latitude: -38.72, longitude: -62.1583333 };
const savv = { latitude: -40.8672222, longitude: -63.0008333 };
...
let mainController = {
  ...
  puntoProbableDeEncuentro: function (req, res) {
    ...
    res.render("puntoProbableDeEncuentro", {
      puntoDeEncuentro: puntoDesplazadoFinal, distanciaPuntoDeEncuentro: distanciaAlBarcoDesdeAeropuertos, datosBarco: datosAportadosUsuario, datosCuadro: distanciasCuadro,
